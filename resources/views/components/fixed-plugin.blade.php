    ...
    <div class="card shadow-lg">
        <div class="card-header pb-0 pt-3 ">
            <div class="float-start">
                <h5 class="mt-3 mb-0">Configuraciones del Panel</h5>
                <p>Mirá nuestras opciones !</p>
            </div>
        ...
        <div class="card-body pt-sm-3 pt-0 overflow-auto">
            ...
            <div class="mt-3">
                ...
                <p class="text-sm">Elegí uno de los tipos de menú.</p>
            </div>
            <div class="d-flex">
            ...
            <p class="text-sm d-xl-none d-block mt-2">Puedes cambiar el color solo en la vista de escritorio.</p>
            <!-- Navbar Fixed -->
