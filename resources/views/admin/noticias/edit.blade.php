...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'Actualizar Noticia'])
                    ...
                    <form role="form" method="POST" action={{ route('noticias.update', $noticia->id) }} enctype="multipart/form-data">
                        ...
                        <div class="card-header pb-0" style="border-radius: 12px !important;">
                            <div class="d-flex align-items-center">
                                <p class="mb-0">Actualizar Noticia</p>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="title" value="{{$noticia->title}}" required>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="example-text-input" class="form-control-label">Título Inglés</label>
                                        <input class="form-control" type="text" name="title_en" value="{{$noticia->title_en}}" required>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="example-text-input" class="form-control-label">Descripción</label>
                                        <textarea class="form-control tinymce" name="content" id="" cols="40" rows="10">{{$noticia->content}}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="example-text-input" class="form-control-label">Descripción Inglés</label>
                                        <textarea class="form-control tinymce" name="content_en" id="" cols="40" rows="10">{{$noticia->content_en}}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                    ...
                                    @if ($noticia->image)
                                        <img src="{{url('storage/'.$noticia->image)}}" class="mt-4 mb-4" alt="" style="width: 100px;">
                                    @endif
                                </div>
                                 ...
                                 <div class="col-md-12">
                                    ...
                                    @if ($noticia->image_en)
                                        <img src="{{url('storage/'.$noticia->image_en)}}" class="mt-4 mb-4" alt="" style="width: 100px;">
                                    @endif
                                </div>
